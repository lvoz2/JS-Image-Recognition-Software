...
window.outputy = [];
window.xvalues = {
	zero: {one: [0,+1,+2,0,+2,0,+2,0,+1,+2],
	       two: [0,-1,+1,-1,+1,0]},
	one: {one: [0,+1,+1,+1,0,+1,+2]},
	two: {one: [0,+1,+2,+2,0,+1,+2,0,0,+1,+2]},
	three: {one: [0,+1,+2,+2,0,+1,+2,+2,0,+1,+2]},
	four: {one: [0,+2,0,+2,0,+1,+2,+3,+2]},
	five: {one: [0,+1,+2,0,0,+1,+2,+2,0,+1,+2]},
	six: {one: [0,+1,+2,0,0,+1,+2,0,+2,0,+1,+2]},
	seven: {one: [0,+1,+2,+2,+1,+1]},
	eight: {one: [0,+1,+2,0,+2,0,+1,+2,0,+2,0,+1,+2]},
	nine: {one: [0,+1,+2,0,+2,0,+1,+2,+2,0,+1,+2]}};
window.yvalues = {
	zero: {one: [0,0,0,+1,+1,+2,+2,+3,+3,+3],
	       two: [0,+1,+1,+2,+2,+3]},
	one: {one: [0,0,+1,+2,+3,+3,+3]},
	two: {one: [0,0,0,+1,+2,+2,+2,+3,+4,+4,+4]},
	three: {one: [0,0,0,+1,+2,+2,+2,+3,+4,+4,+4]},
	four: {one: [0,0,+1,+1,+2,+2,+2,+2,+3]},
	five: {one: [0,0,0,+1,+2,+2,+2,+3,+4,+4,+4]},
	six: {one: [0,0,0,+1,+2,+2,+2,+3,+3,+4,+4,+4]},
	seven: {one: [0,0,0,+1,+2,+3]},
	eight: {one: [0,0,0,+1,+1,+2,+2,+2,+3,+3,+4,+4,+4]},
	nine: {one: [0,0,0,+1,+1,+2,+2,+2,+3,+4,+4,+4]}};
function reset() {
	for (var i = 0; i < 10; i++) {
		for (var g = 0; g < 10; g++) {
